...
ggarrange(
  p_ent, p_pred, p_CE_rank1, p_true_CE_rank1,
...
df_CE_Rank1$category <- 'Co-locationship'
df_CE_Rank1$meetup <- NULL
df_true_CE_Rank1$category <- 'Social relationship'
...
all_final_CN_SN <- subset(all_final, category %in% c("CB-1H-CN",
                                                "Social relationship"))
all_final_CN_SN$category[all_final_CN_SN$category=="CB-1H-CN"]<-"Co-locationship"
...
vip_LR_CN_SN <- vip_LR %>% filter((LR == "USLR") & 
                                    (category %in% c("CB-1H-CN", 
                                                     'Social relationship')))
vip_LR_CN_SN$category[vip_LR_CN_SN$category=="CB-1H-CN"]<-"Co-locationship"
...
vip_CV$category[vip_CV$category=="CB-1H-CN"]<-"Co-locationship"
